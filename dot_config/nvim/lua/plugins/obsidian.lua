-- Using Epilande blink hack
-- https://github.com/epilande/dotfiles/blob/master/nvim/.config/nvim-lazyvim/lua/plugins/obsidian.lua
return {
  {
    ...
    event = {
      "BufReadPre " .. vim.fn.resolve(vim.fn.expand("~/Zettelkasten")) .. "/*",
      "BufNewFile " .. vim.fn.resolve(vim.fn.expand("~/Zettelkasten")) .. "/*",
    },
    dependencies = {
